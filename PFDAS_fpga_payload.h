 ...
 * \return Number of samples that are now in the output buffer.
 */
 ...
 * 
 * \param input_buffer_32 Pointer to the sample data that will overwrite the ADC sample data.
 * \param buffer_fpga_ch Pointer to the 1 channels worth of ADC data.
 * \param input_buffer_size The allocated size of the input_buffer_32. 
 * \return void
 */
